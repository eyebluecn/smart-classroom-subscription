package com.smart.classroom.subscription.repository.config;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.smart.classroom.subscription.repository"}, sqlSessionFactoryRef = "sqlSessionFactory")
