package com.smart.classroom.subscription.tool.saber.config;
...
public interface SaberConfig {
    ...
    //仓储层的模块名
    String REPOSITORY_MODULE_NAME = "scs-repository";

    //基础包名，即所有类共同的包名前缀。
    String BASE_PACKAGE_NAME = "com.smart.classroom.subscription";

    //数据库表前缀
    String DATABASE_TABLE_PREFIX = "scs_";
